    ...
    >
      ...
      {showTooltip && (
        <motion.div
          ...
          className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 p-3 bg-slate-800 dark:bg-stone-200 text-slate-100 dark:text-stone-800 rounded-lg shadow-lg whitespace-nowrap z-20 min-w-max"
        >
          ...
          <div className="absolute top-full left-1/2 transform -translate-x-1/2 border-4 border-transparent border-t-slate-800 dark:border-t-stone-200" />
        </motion.div>
      )}
    </motion.div>
  )
